...
此项目使用`Unity 2022`开发，使用了`DOTwnnt`和`Spine`插件。

页面展示使用了作者`Itxcm`开源的[Card-Online-Game
](https://github.com/Itxcm/Card-Online-Game)项目的客户端部分。

算法部分借鉴了`爱编程的大丙`的[Qt斗地主项目](https://www.bilibili.com/video/BV1zq4y1q74h)项目和作者`Avalon712`开源的[ProkerUtils-For-FightingTheLandlord
